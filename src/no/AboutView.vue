      ...
      <el-container>
        ...
        <el-main>
          <div style="padding: 10px 0">
            ...
            <el-input style="width: 200px;margin: 0 5px 0 5px" suffix-icon="el-icon-search" placeholder="请输入名称" v-model="studentname"></el-input>

            <el-input style="width: 200px;margin: 0 5px 0 5px" suffix-icon="el-icon-user" placeholder="请输入性别" v-model="sex"></el-input>

            <el-input style="width: 200px;margin: 0 5px 0 5px" suffix-icon="el-icon-reading" placeholder="请输入需要补习的科目" v-model="subject"></el-input>
          ...
          <el-table :data="tableData" border style="width: 100%"  @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="studentname" label="学院名称" width="120">
            </el-table-column>
